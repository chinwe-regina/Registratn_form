    ...
    return <Form>
        ...
        <Card>
            <CardTitle>
                ...
                <nav>Let's know more about you</nav>
            </CardTitle>
            <InputWrap>
                <Input placeholder="FirstName" type="text" />
                <Input placeholder="LastName" type="text" />
                <Input placeholder="Marital Status" type="text" />
                <Input placeholder="Residence Address" type="text" />
                <Input placeholder="Hobbies" type="text" />
            </InputWrap>
            <ButtonHold>
            <Button bg="#640b12" onClick={()=>{localStorage.setItem("page", JSON.stringify(2))
             window.location.reload()}}>PREVIOUS</Button>
            <Button bg="#045704" onClick={()=>{localStorage.setItem("page", JSON.stringify(4))
